...
const DEFAULT_API_BASE = process.env.YOUCHAT_API_BASE || "http://host.docker.internal:18080/api";
const FNOS_MYSQL_CONNECTION_STRING = process.env.YOUCHAT_MYSQL_CONNECTION_STRING || "";
