const DEFAULT_API_BASE = "http://host.docker.internal:18080/api";
...
function hydrateLoginFields() {
  ...
  el.serverAddress.value = parsed.isFull ? parsed.address : (parsed.host || "host.docker.internal");
...
function parseApiBase(value) {
  ...
  try {
    ...
    return { address: DEFAULT_API_BASE, host: "host.docker.internal", port: "18080", isFull: false };
  }
}
